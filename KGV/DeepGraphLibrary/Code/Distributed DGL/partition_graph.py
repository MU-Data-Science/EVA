...
from load_genomics import load_genomics_graph
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--node_path', type=str, help='Input path for nodes.')
    argparser.add_argument('--edge_path', type=str, help='Input path for edges.')
    ...
    if args.dataset == 'reddit':
        ...
        g = load_genomics_graph(args.node_path, args.edge_path)
